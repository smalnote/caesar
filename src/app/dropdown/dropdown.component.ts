...
export class DropdownComponent implements OnInit {
  ...
  addrs = {
    'PAAS': {
      'DEV': {
        'LK01-PortfolioOltp': new Addr('http://LK01-PortfolioOltp.paas.cmbchina.cn/rmi.do', '', 0),
        'LT17-Data': new Addr('http://LT17-Data.paas.cmbchina.cn/rmi.do', '', 0)
      },
      'ST': {
        'LK01-PortfolioOltp': new Addr('http://LK01-PortfolioOltp.paasst.cmbchina.cn/rmi.do', '', 0),
        'LT17-Data': new Addr('http://LT17-Data.paasst.cmbchina.cn/rmi.do', '', 0)
      },
      'UAT': {
        'LK01-PortfolioOltp': new Addr('http://LK01-PortfolioOltp.paasuat.cmbchina.cn/rmi.do', '', 0),
        'LT17-Data': new Addr('http://LT17-Data.paasuat.cmbchina.cn/rmi.do', '', 0)
      }
    },
    'AS400': {
      'DEV': {
